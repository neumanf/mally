...
<#assign xKeycloakify={
    ...
    "ftlTemplateFileName": "update-user-profile.ftl",
    "themeType": "login",
    "themeName": "keycloakify-starter",
    "keycloakifyVersion": "11.2.0",
    "themeVersion": "0.0.0",
    "resourcesPath": ""
}>
...
<#macro addNonAutomaticallyGatherableMessagesToXKeycloakifyMessages>
    ...
    <#if requiredActions?? && requiredActions?is_enumerable>
        ...
        <link rel="icon" type="image/svg" sizes="32x32" href="${xKeycloakify.resourcesPath}/dist/favicon.svg">
      <script type="module" crossorigin="" src="${xKeycloakify.resourcesPath}/dist/assets/index-DM0cH0Lj.js"></script>
    </head>
